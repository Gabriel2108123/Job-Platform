        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ConversationId1 = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    HashedToken = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateProfiles_DateOfBirth",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_ApplicationId_OrganizationId",
                table: "Conversations",
                columns: new[] { "ApplicationId", "OrganizationId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationTokens_HashedToken",
                table: "EmailVerificationTokens",
                column: "HashedToken");
